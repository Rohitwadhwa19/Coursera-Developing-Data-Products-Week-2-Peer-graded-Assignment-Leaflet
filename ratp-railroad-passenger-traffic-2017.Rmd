---
title: "Passenger Traffic on the Paris RATP Railway Network in 2017"
author: "Rohit Wadhwa"
...
The following map represents passenger traffic on the Paris RATP railway network in 2017. Clicking on a station shows the total number of passengers that entered the station during that year.
...
station_traffic <- read.csv2(
  "data/trafic-annuel-entrant-par-station-du-reseau-ferre-2017.csv",
...
- [Trafic annuel entrant par station du réseau ferré 2017](https://data.ratp.fr/explore/dataset/trafic-annuel-entrant-par-station-du-reseau-ferre-2017/export/) (annual traffic by station on railway network 2017), released under the [Etalab Open License](https://www.etalab.gouv.fr/licence-ouverte-open-licence).
